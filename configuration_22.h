...
//Section #3. ========= setup number of Banks/Extenders and LED "strips" in each bank =========================
...
#if  HAS_BANKS
    /*
    Led strips are limited in the number of LEDs that can be addressed on each strip. Too many leds
    ...
    */
    ...
    Depending on what Teensy pins are used for other purposes, the Extender Shield
    allow you to rotate the Teensy MCU 180 degrees. Normal placement of the Teensy on the Extender Shield
    ...
    Alternate pins (18-21) depend on how Teensy is rotated on the Extender Shield
    */
