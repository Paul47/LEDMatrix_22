...
*/
#define MATRIX_WIDTH    48    //former LEDMatrix use negative value for reversed (right to left)
#define MATRIX_HEIGHT   64  //former LEDMatrix use negative value for reversed (bottom to top)
