...
*/
#define NEXT_PATTERN_BUTTON_PIN  A0  // button between this pin and ground
#define AUTOCYCLE_SWITCH_PIN  A1  // switch between this pin and ground
...
{
  const uint8_t maxBrightness = 255;  // max brightness for the colors
