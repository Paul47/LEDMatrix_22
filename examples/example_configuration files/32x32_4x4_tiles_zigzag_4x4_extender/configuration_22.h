...
#define refresh_fps     60  //working: 10-60    //default in chip defines is 400
#define BRIGHTNESS      5  //10  //working: 20 to 40. ??? with 2 power supplies up to 100
...
#define HAS_EXTENDER  true  //true/false Dr Oldies LED Extender shields                                       //ppd
    ...
    */
    ...
    #define BANK_PIN_0          5   //5 - 18   //depends on how Teensy is rotated on the Extender boar
    #define BANK_PIN_1          6   //6 - 19
    #define BANK_PIN_2          7   //7 - 20
    #define BANK_PIN_3          8   //8 - 21
    /*
    #define BANK_PIN_0          18   //5 - 18   //depends on how Teensy is rotated on the Extender boar
    #define BANK_PIN_1          19   //6 - 19
    #define BANK_PIN_2          20   //7 - 20
    #define BANK_PIN_3          21   //8 - 21
    */
    ...
    */
    ...
    #define DATA_1          1       //1 - 14   //depends on how Teensy is rotated on the Extender board   
    #define CLOCK_1         2       //2 - 15
    #define DATA_2          3       //3 - 16
    #define CLOCK_2         4       //4 - 17
    /*
    #define DATA_1          14       //1 - 14   //depends on how Teensy is rotated on the Extender board   
    #define CLOCK_1         15       //2 - 15
    #define DATA_2          16       //3 - 16
    #define CLOCK_2         17       //4 - 17
    */
